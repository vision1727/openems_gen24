...
public class EssSmaSunnyIslandImpl extends AbstractOpenemsModbusComponent
		...
		SymmetricEss, ModbusComponent, OpenemsComponent,StartStoppable {
...
//	protected static final int NET_CAPACITY = 40320;
	protected static final int MAX_APPARENT_POWER = 18000;
	...
	protected ModbusProtocol defineModbusProtocol() {
		return new ModbusProtocol(this, //
				...
				new FC16WriteRegistersTask(40149, //
						...
						m(EssSmaSunnyIsland.ChannelId.SET_CONTROL_MODE, new SignedDoublewordElement(40151))), 
